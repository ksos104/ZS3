...
with open(r'/mnt/server14_hard1/msson/datasets/zs3_datasets/coco/coco_stuff/split/seen_indexes.json', 'w') as f_out:
    json.dump(seen_classnames, f_out)

with open(r'/mnt/server14_hard1/msson/datasets/zs3_datasets/coco/coco_stuff/split/unseen_indexes.json', 'w') as f_out:
    json.dump(unseen_classnames, f_out)

with open(r'/mnt/server14_hard1/msson/datasets/zs3_datasets/coco/coco_stuff/split/all_indexes.json', 'w') as f_out:
